...
isc.TextAreaItem.addProperties({
    ...
    //> @attr TextAreaItem.showHintInField (Boolean : null : IRW)
...
isc.TextAreaItem.addMethods({
    ...
    getElementHTML : function (value, dataValue) {
        ...
        if (!this.showValueIconOnly && this.showInputElement != false) {
            ...
            // In this case we'll also disallow clipping so the static text-box will expand to accommodate
            // content.
    ...
    // isMultiLineEditor is true for TextAreas - used by LG
    isMultiLineEditor: true,
    // hasInternalNavigation is true for TextAreas - used by ComponentEditor
