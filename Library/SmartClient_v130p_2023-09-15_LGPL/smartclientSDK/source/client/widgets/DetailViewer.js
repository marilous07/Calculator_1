...
isc.DetailViewer.addProperties({
    ...
    //> @attr detailViewer.dataArity (String : "either" : IRWA)
    // A DetailViewer is a +link{dataBoundComponent.dataArity,dataArity}:either component by
    // default which means data population from +link{canvas.dataContext} will be treated like
    // a DynamicForm (i.e. single). However, by explicitly marking an instance of DetailViewer
    // as <code>dataArity:multiple</code>, <code>dataContext</code> population will be treated
    // similarly to a ListGrid.
    // @visibility external
    //<
...
//<    
// Implemented in DataBoundComponent

supportedViewStates:[
    // Use the ...AsObject state getters so getViewState() can return an object if requested
    {stateType:"field", getter:"getFieldStateAsObject", setter:"setFieldState"},
    {stateType:"hilite", getter:"getHiliteStateAsObject", setter:"setHiliteState"}
],
