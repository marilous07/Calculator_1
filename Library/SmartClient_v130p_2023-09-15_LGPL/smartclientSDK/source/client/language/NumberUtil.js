...
//> @classAttr NumberUtil.currencySymbolLast (Boolean : false : IR)
// If true, show any currency symbol after the number when formatting numbers.  If false, show
// any currency symbol before the number
// @visibility external
//<
currencySymbolLast : false,

//> @classAttr NumberUtil.negativeFormat (Number : 1 : IR)
// The format to use when formatting negative numbers.  Supported values are: 1 = before, 
...
//                                      string?  If unspecified, and not defined in the locale,
//                                      it will prefix the number.
...
_toCurrencyString : function (currencyChar, decimalChar, padDecimal, currencyCharLast, number) {
    ...
    if (currencyCharLast == null) {
        currencyCharLast = isc.NumberUtil.currencySymbolLast;
    }
