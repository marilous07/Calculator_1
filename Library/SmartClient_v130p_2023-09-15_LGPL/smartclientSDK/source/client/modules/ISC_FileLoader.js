...
var libs = 
	[
        ...
        "standalone/SA_Core",
        "standalone/SA_Page",
        "standalone/SA_XMLHttp",
		"communications/FileLoader"
	];
...
(function () {
    ...
    loadLib("language/startDefiningFramework", "#module=FileLoader");
    for (var i = 0, l = libs.length; i < l; ++i) {
        if (!libs[i]) continue;
        if (window.UNSUPPORTED_BROWSER_DETECTED == true) break;
        loadLib(libs[i]);
    }
    loadLib("language/stopDefiningFramework", "#module=FileLoader");
})();
