...
isc.Slider.create({
    minValue:1, maxValue:20, numValues:21, showRange:false, labelWidth:40,
    title:"Softness", value:10,
    valueChanged: "textBox.shadowSoftness = value; textBox.updateShadow();"
})

isc.Slider.create({
    minValue:-10, maxValue:10, numValues:21, showRange:false, labelWidth:40,
    title:"Offset", left:80, value:0,
