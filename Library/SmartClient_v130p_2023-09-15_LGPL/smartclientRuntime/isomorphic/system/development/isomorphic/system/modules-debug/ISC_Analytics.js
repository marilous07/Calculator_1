...
if(isc.Log && isc.Log.logDebug)isc.Log.logDebug(isc._pTM.message,'loadTime');
...
else isc._preLog=[isc._pTM]}isc.definingFramework=true;if(window.isc&&isc.version!="v13.0p_2023-09-15/EVAL Deployment"&&!isc.DevUtil){
    isc._optionalModuleCompare=function(){
        ...
        if(isc.version.toLowerCase().contains("pro")||isc.version.toLowerCase().contains("lgpl")){
            ...
            var moduleVersion="v13.0p_2023-09-15/EVAL Deployment";
...
isc.evalBoundary;isc.B.push(isc.A.inMultiFacetColumn=function isc_CubeGrid_inMultiFacetColumn(facetId){
...
isc.evalBoundary;isc.B.push(isc.A.getFacetChartMenu=function isc_CubeGrid_getFacetChartMenu(facetId){
}
