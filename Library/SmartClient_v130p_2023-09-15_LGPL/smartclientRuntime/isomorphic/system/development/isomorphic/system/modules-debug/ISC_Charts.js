...
if (window.isc && isc.version != "v13.0p_2023-09-15/EVAL Deployment" && !isc.DevUtil) {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v13.0p_2023-09-15/EVAL Deployment'. Mixing resources from different "
...
isc.evalBoundary;isc.B.push(isc.A.setRegressionPolynomialDegree=function isc_FacetChart_setRegressionPolynomialDegree(regressionPolynomialDegree){
...
isc.evalBoundary;isc.B.push(isc.A._drawPointSizeLegend=function isc_FacetChart__drawPointSizeLegend(){
    var legendFacet=this.getLegendFacet(),
        metricFacet=this._getMetricFacet(),
        pointSizeMetric=this._getPointSizeMetric(),
        undef;
...
isc.evalBoundary;isc.B.push(isc.A._getColorMutePercent=function isc_FacetChart__getColorMutePercent(colorMutePercent,defaultColorMutePercent){
...
isc.evalBoundary;isc.B.push(isc.A._getZoomChartLabelCollapseMode=function isc_FacetChart__getZoomChartLabelCollapseMode(){
...
utility:function(width,height,measure){
    ...
    if(measure._singular)labelCount=1;
