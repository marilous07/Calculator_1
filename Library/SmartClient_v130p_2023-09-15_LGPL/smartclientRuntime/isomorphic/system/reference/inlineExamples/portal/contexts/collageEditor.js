...
isc.TilePalette.create({
    ...
    fields: [{
        ...
        formatCellValue : function (value, record, rowNum, colNum, grid) {
            var docsDir = isc.Page.getSamplePhotoDir();
            return "<img src='" + docsDir + record.defaults.src + 
